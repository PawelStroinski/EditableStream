...
namespace StreamUtils
{
    public abstract class EditableStream : Stream, IDisposable
    {
        ...
        class TransposeHelper
        {
            ...
            /// </summary>
            /// <param name="write">The target writable stream</param>
            /// <param name="read">The target readable stream</param>
            ...
            public TransposeHelper(Stream write, Stream read, long sourcePosition, long length,
